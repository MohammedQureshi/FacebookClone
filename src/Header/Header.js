    ...
    return (
        <div className="FacebookClone__Header">
            ...
            <div className="FacebookClone__Navigation">
                ...
                <button><OndemandVideoIcon /></button>
                <button><StorefrontIcon /></button>
                <button><PeopleIcon /></button>
                <button><ViewCarouselIcon /></button>
            </div>
            <div className="FacebookClone__Settings">
                <Avatar alt="Avatar" src="https://media-exp3.licdn.com/dms/image/C4E03AQF2s8dGWpgC5g/profile-displayphoto-shrink_200_200/0/1592998404125?e=1629331200&v=beta&t=5IRMkWHeb6gNJBhmuZZcLKYNGjyaJ6Pd3F-ER5lVRxY" className="FacebookClone__SettingsAvatar" />
                <h3> Mohammed </h3>
